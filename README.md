...
- Replace `KuzmenkoGit` with your Github username in the [DEMO LINK](https://KuzmenkoGit.github.io/react_dynamic-list-of-goods/) and add it to the PR description.
